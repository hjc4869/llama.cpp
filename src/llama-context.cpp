...
llama_context::llama_context(
    ...
    LLAMA_LOG_INFO("%s: min_offload_batch_size  = %d\n",   __func__, cparams.min_offload_batch_size);
    ...
    if (!hparams.vocab_only) {
        ...
        ggml_backend_sched_set_min_offload_batch_size(sched.get(), cparams.min_offload_batch_size);
    }
